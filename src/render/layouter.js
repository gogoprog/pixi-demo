...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5286416,
    DYNAMIC_BASE = 5286416,
    DYNAMICTOP_PTR = 43504;
...
function nullFunc_diiidii(x) { err("Invalid function pointer called with signature 'diiidii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)");  err("Build with ASSERTIONS=2 for more info.");abort(x) }
...
function nullFunc_viiiidd(x) { err("Invalid function pointer called with signature 'viiiidd'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)");  err("Build with ASSERTIONS=2 for more info.");abort(x) }
...
var asmLibraryArg = {
  ...
  "nullFunc_diiidii": nullFunc_diiidii,
  ...
  "nullFunc_viiiidd": nullFunc_viiiidd,
